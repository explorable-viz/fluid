...
def parse():
  ...
  test_names = ['convolution/edgeDetect', 'convolution/emboss', 'convolution/gaussian', 'graphics/grouped-bar-chart', 'graphics/line-chart', 'graphics/stacked-bar-chart', 'slicing/dtw/compute-dtw']
  df = pd.DataFrame(benchmarks.loc[test_names])
  print(df[['Trace-Eval', 'Trace-Bwd', 'Graph-Eval', 'Graph-Bwd']])
