...
test_misc is_bench = testMany is_bench
   [ (File "arithmetic") × "42"
   , (File "array") × "(1, (3, 3))"
   , (File "compose") × "5"
...
test_bwd is_bench = testBwdMany is_bench
...
test_graphics is_bench = testWithDatasetMany is_bench
