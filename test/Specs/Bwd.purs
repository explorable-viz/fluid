...
bwd_cases =
   ...
   , { file: "linked-outputs/bar-chart-line-chart"
     ...
     , δv: multiPlotEntry "bar-chart" (barChart (barSegment 1 0 neg))
   ...
   , { file: "linked-outputs/stacked-bar-scatter-plot"
     ...
     , δv: multiPlotEntry "stacked-bar-chart" (barChart (barSegment 3 2 neg >>> barSegment 4 1 neg >>> barSegment 4 3 neg))
