...
comments_cases =
   [ { file: "comments/nested-constr.fld"
     , fwd_expect: "@doc (Paragraph (Text \"This\" : (Text \"is\" : (Text \"a\" : (Text (@doc (Paragraph (Text \"This\" : (Text \"is\" : (Text \"a\" : (Text \"nested\" : (Text \"docComment!\" : [])))))) \"some string\") : (Text \"docComment!\" : [])))))) False"
     }
   , { file: "comments/dicts.fld"
     , fwd_expect:
          "@doc (Paragraph (Text \"We\" : (Text \"can\" : (Text \"have\" : (Text \"a\" : (Text \"docComment\" : (Text \"before\" : (Text \"a\" : (Text \"dict!\" : []))))))))) {[\"d\"] : {}, [\"e\"] : {[\"a\"] : 5, [\"ab\"] : 6}, [\"e_ab\"] : 6, [\"f\"] : {[\"a\"] : 6, [\"ab\"] : 7}, [\"g\"] : {[\"a\"] : 5}}"
     }
