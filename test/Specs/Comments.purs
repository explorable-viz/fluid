...
comments_cases =
   ...
   , { file: "comments/app-arg", imports: [], fwd_expect: "(5 : (7 : (13 : (15 : (4 : (3 : (-3 : [])))))))" }
   ...
   , { file: "comments/projection", imports: [], fwd_expect: "(1, \"\"\" Outermost \"\"\" 1)" }
   , { file: "comments/nested-projection", imports: [], fwd_expect: "1" }
   ]
