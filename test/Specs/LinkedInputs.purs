...
import App.Util.Selector (envRVal, field, listElement)
...
linkedInputs_spec3 =
   ...
   , in_expect:
        envRVal "nonRenewables" (listElement 51 (field "coalCap" neg >>> field "gasCap" neg >>> field "nuclearCap" neg >>> field "petrolCap" neg)) >>>
           envRVal "renewables"
