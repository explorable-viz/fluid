...
type SuiteFactory r m = MonadError Error m => HasClassCtx m => MonadReader FileCxt m => LoadFile m => Array { file :: String | r } -> BenchSuite m

suite :: forall m. MonadAff m => MonadError Error m => HasClassCtx m => MonadReader FileCxt m => LoadFile m => Array TestSpec -> BenchSuite m
...
bwdSuite :: forall m. MonadAff m => MonadError Error m => HasClassCtx m => MonadReader FileCxt m => LoadFile m => Array TestBwdSpec -> BenchSuite m
...
linkedOutputsTest :: forall m. MonadAff m => MonadError Error m => HasClassCtx m => MonadReader FileCxt m => LoadFile m => TestLinkedOutputsSpec -> m Fig
...
linkedOutputsSuite :: forall m. MonadAff m => MonadError Error m => HasClassCtx m => MonadReader FileCxt m => LoadFile m => Array TestLinkedOutputsSpec -> Array (String × m Unit)
linkedOutputsSuite testSpecs = testSpecs <#> (_.file &&& (linkedOutputsTest >>> void))

linkedInputsTest :: forall m. MonadAff m => MonadError Error m => HasClassCtx m => MonadReader FileCxt m => LoadFile m => TestLinkedInputsSpec -> m Fig
...
linkedInputsSuite :: forall m. MonadAff m => MonadError Error m => HasClassCtx m => MonadReader FileCxt m => LoadFile m => Array TestLinkedInputsSpec -> Array (String × m Unit)
...
illFormedSuite :: forall m. MonadAff m => MonadError Error m => HasClassCtx m => MonadReader FileCxt m => LoadFile m => Array IllFormedSpec -> Array (String × m Unit)
