...
export var ParserRules: NearleyRule[] = [
    {"name": "rootExpr", "symbols": ["_", "expr"], "postprocess": (d: any[]) => d[1]},
    ...
    {"name": "var$macrocall$1", "symbols": ["var$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "string$macrocall$1", "symbols": ["string$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    {"name": "string", "symbols": ["string$macrocall$1"], "postprocess": (d: any[]) => Expr.constStr(ν(), str(ν(), d[0] as string))},
    {"name": "number$macrocall$2", "symbols": ["number_"]},
    {"name": "number$macrocall$1", "symbols": ["number$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "parenthExpr$macrocall$1", "symbols": ["parenthExpr$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    {"name": "parenthExpr$macrocall$4", "symbols": [{"literal":")"}]},
    {"name": "parenthExpr$macrocall$3", "symbols": ["parenthExpr$macrocall$4", "_"], "postprocess": (d: any[]) => d[0]},
    {"name": "parenthExpr", "symbols": ["parenthExpr$macrocall$1", "expr", "parenthExpr$macrocall$3"], "postprocess": (d: any[]) => d[1]},
    {"name": "pair$macrocall$2", "symbols": [{"literal":"("}]},
    {"name": "pair$macrocall$1", "symbols": ["pair$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    {"name": "pair$macrocall$4", "symbols": [{"literal":","}]},
    {"name": "pair$macrocall$3", "symbols": ["pair$macrocall$4", "_"], "postprocess": (d: any[]) => d[0]},
    {"name": "pair$macrocall$6", "symbols": [{"literal":")"}]},
    {"name": "pair$macrocall$5", "symbols": ["pair$macrocall$6", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "defs1$macrocall$1$macrocall$1", "symbols": ["defs1$macrocall$1$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "list$macrocall$1", "symbols": ["list$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    {"name": "list$macrocall$4", "symbols": [{"literal":"]"}]},
    {"name": "list$macrocall$3", "symbols": ["list$macrocall$4", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "typematch$macrocall$1$macrocall$1", "symbols": ["typematch$macrocall$1$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "typematch$macrocall$3$macrocall$1", "symbols": ["typematch$macrocall$3$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "defList$ebnf$1$subexpression$1$macrocall$1", "symbols": ["defList$ebnf$1$subexpression$1$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "let$macrocall$1$macrocall$1", "symbols": ["let$macrocall$1$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    {"name": "let$macrocall$1", "symbols": ["let$macrocall$1$macrocall$1"]},
    {"name": "let$macrocall$4", "symbols": [{"literal":"="}]},
    {"name": "let$macrocall$3", "symbols": ["let$macrocall$4", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "letrec$macrocall$1$macrocall$1", "symbols": ["letrec$macrocall$1$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "letrec$ebnf$1$subexpression$1$macrocall$1", "symbols": ["letrec$ebnf$1$subexpression$1$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "recDef$macrocall$1$macrocall$1", "symbols": ["recDef$macrocall$1$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "fun$macrocall$1$macrocall$1", "symbols": ["fun$macrocall$1$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "matchAs$macrocall$1$macrocall$1", "symbols": ["matchAs$macrocall$1$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "matchAs$macrocall$3$macrocall$1", "symbols": ["matchAs$macrocall$3$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "matches$macrocall$1", "symbols": ["matches$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    {"name": "matches$ebnf$1", "symbols": []},
    {"name": "matches$ebnf$1$subexpression$1$macrocall$2", "symbols": [{"literal":";"}]},
    {"name": "matches$ebnf$1$subexpression$1$macrocall$1", "symbols": ["matches$ebnf$1$subexpression$1$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "matches$macrocall$3", "symbols": ["matches$macrocall$4", "_"], "postprocess": (d: any[]) => d[0]},
    {"name": "matches", "symbols": ["matches$macrocall$1", "match", "matches$ebnf$1", "matches$macrocall$3"]},
    {"name": "match$macrocall$2", "symbols": [{"literal":"→"}]},
    {"name": "match$macrocall$1", "symbols": ["match$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "typeMatches$macrocall$1", "symbols": ["typeMatches$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    {"name": "typeMatches$ebnf$1", "symbols": []},
    {"name": "typeMatches$ebnf$1$subexpression$1$macrocall$2", "symbols": [{"literal":";"}]},
    {"name": "typeMatches$ebnf$1$subexpression$1$macrocall$1", "symbols": ["typeMatches$ebnf$1$subexpression$1$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "typeMatches$macrocall$3", "symbols": ["typeMatches$macrocall$4", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "typeMatch$macrocall$1", "symbols": ["typeMatch$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    {"name": "typeMatch$macrocall$4", "symbols": [{"literal":"→"}]},
    {"name": "typeMatch$macrocall$3", "symbols": ["typeMatch$macrocall$4", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "listOpt$ebnf$1$subexpression$1$macrocall$1", "symbols": ["listOpt$ebnf$1$subexpression$1$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "listRestOpt$macrocall$1", "symbols": ["listRestOpt$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    {"name": "listRestOpt$macrocall$4", "symbols": [{"literal":"..."}]},
    {"name": "listRestOpt$macrocall$3", "symbols": ["listRestOpt$macrocall$4", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "pair_pattern$macrocall$1", "symbols": ["pair_pattern$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    {"name": "pair_pattern$macrocall$4", "symbols": [{"literal":","}]},
    {"name": "pair_pattern$macrocall$3", "symbols": ["pair_pattern$macrocall$4", "_"], "postprocess": (d: any[]) => d[0]},
    {"name": "pair_pattern$macrocall$6", "symbols": [{"literal":")"}]},
    {"name": "pair_pattern$macrocall$5", "symbols": ["pair_pattern$macrocall$6", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "list_pattern$macrocall$1", "symbols": ["list_pattern$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    {"name": "list_pattern$macrocall$4", "symbols": [{"literal":"]"}]},
    {"name": "list_pattern$macrocall$3", "symbols": ["list_pattern$macrocall$4", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "listOpt_pattern$ebnf$1$subexpression$1$macrocall$1", "symbols": ["listOpt_pattern$ebnf$1$subexpression$1$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "listRestOpt_pattern$macrocall$1", "symbols": ["listRestOpt_pattern$macrocall$2", "_"], "postprocess": (d: any[]) => d[0]},
    {"name": "listRestOpt_pattern$macrocall$4", "symbols": [{"literal":"..."}]},
    {"name": "listRestOpt_pattern$macrocall$3", "symbols": ["listRestOpt_pattern$macrocall$4", "_"], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "compareOp$macrocall$1", "symbols": ["compareOp$macrocall$2", (lexer.has("WS") ? {type: "WS"} : WS)], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "exponentOp$macrocall$1", "symbols": ["exponentOp$macrocall$2", (lexer.has("WS") ? {type: "WS"} : WS)], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "productOp$macrocall$1", "symbols": ["productOp$macrocall$2", (lexer.has("WS") ? {type: "WS"} : WS)], "postprocess": (d: any[]) => d[0]},
    ...
    {"name": "sumOp$macrocall$1", "symbols": ["sumOp$macrocall$2", (lexer.has("WS") ? {type: "WS"} : WS)], "postprocess": (d: any[]) => d[0]},
