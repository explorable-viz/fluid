...
export var ParserRules: NearleyRule[] = [
    ...
    {"name": "appChain$ebnf$1", "symbols": ["simpleExpr"]},
    {"name": "appChain$ebnf$1", "symbols": ["appChain$ebnf$1", "simpleExpr"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "appChain", "symbols": ["appChain$ebnf$1"]},
