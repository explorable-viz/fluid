...
export var ParserRules: NearleyRule[] = [
    ...
    {"name": "listOpt$ebnf$1$subexpression$1$macrocall$1", "symbols": ["listOpt$ebnf$1$subexpression$1$macrocall$2", "_"]},
    ...
    {"name": "listOpt_pattern$ebnf$1$subexpression$1$macrocall$1", "symbols": ["listOpt_pattern$ebnf$1$subexpression$1$macrocall$2", "_"]},
    ...
    {"name": "listRestOpt_pattern$macrocall$1", "symbols": ["listRestOpt_pattern$macrocall$2", "_"]},
    {"name": "listRestOpt_pattern$macrocall$4", "symbols": [{"literal":"..."}]},
    {"name": "listRestOpt_pattern$macrocall$3", "symbols": ["listRestOpt_pattern$macrocall$4", "_"]},
