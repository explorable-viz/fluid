...
instance Highlightable a => Pretty (E.Expr a) where
   ...
   pretty (E.Project doc e (E.Str _ _ x)) = pretty doc .<>. pretty e .<>. text str.dot .<>. pretty x
   pretty (E.Project doc e x) = pretty doc .<>. pretty e .<>. text str.dot .<>. text str.lBracket .<>. pretty x .<>. text str.rBracket
