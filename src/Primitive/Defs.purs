...
import Primitive (Binary, Unary, binary, binaryZero, toFromInt, toFromIntPair, toFromMatrixRep, toFromNumber, toFromString, toFromVal, unary, unary2, union, union1, unionStr, withInverse1, withInverse2)
