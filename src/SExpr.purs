...
exprBwd' :: forall a. BoundedJoinSemilattice a => E.Expr a -> Expr a
exprBwd' e = desugBwd' e
...
exprBwd
   ...
   in
      case exprBwd' (asExpr (pattContBwd p (asElim σ'))) of
         ListComp β' s2' qs' ->
            ListComp (β ∨ β') s2' (Generator p (exprBwd' e1) : qs')
         _ -> error absurd
