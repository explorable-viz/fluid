...
export var ParserRules: NearleyRule[] = [
    ...
    {"name": "string", "symbols": ["string$macrocall$1"], "postprocess": ([[lit]]) => Expr.constStr(ν(), str(ν(), (lit.value as string).slice(1, -1)))},
    ...
    {"name": "number", "symbols": ["number$macrocall$1"], "postprocess": ([[lit]]) => Expr.constNum(ν(), num(ν(), new Number(lit.value as string).valueOf()))},
    ...
    {"name": "listOpt", "symbols": [], "postprocess": () => Expr.constr(ν(), str(ν(), Nil.name), nil())},
    ...
    {"name": "listRestOpt", "symbols": [], "postprocess": () => Expr.constr(ν(), str(ν(), Nil.name), nil())},
    ...
    {"name": "pair_pattern", "symbols": ["pair_pattern$macrocall$1", "pattern", "pair_pattern$macrocall$3", "pattern", "pair_pattern$macrocall$5"], "postprocess": ([, mk_κ1, , mk_κ2, ,]) => (κ: Cont) => Trie.constr(singleton(str(ν(), Pair.name), compose(mk_κ1, mk_κ2)(κ)))},
