...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "compareExpr", "symbols": ["compareExpr", "compareOp", "sumExpr"], "postprocess": ([e1, op, e2]) => Expr.binaryApp(ν(), e1, str(op)(ν()), e2)},
    {"name": "compareExpr", "symbols": ["sumExpr"], "postprocess": id},
    {"name": "sumExpr", "symbols": ["sumExpr", "sumOp", "productExpr"], "postprocess": ([e1, op, e2]) => Expr.binaryApp(ν(), e1, str(op)(ν()), e2)},
    {"name": "sumExpr", "symbols": ["productExpr"], "postprocess": id},
    {"name": "productExpr", "symbols": ["productExpr", "productOp", "exponentExpr"], "postprocess": ([e1, op, e2]) => Expr.binaryApp(ν(), e1, str(op)(ν()), e2)},
    ...
    {"name": "string", "symbols": ["string$macrocall$1"], "postprocess": ([[lit]]) => Expr.constStr(ν(), str((lit.value as string).slice(1, -1))(ν()))},
    ...
    {"name": "listOpt", "symbols": [], "postprocess": () => Expr.constr(ν(), str(Nil.name)(ν()), nil())},
    ...
    {"name": "listOpt", "symbols": ["expr", "listOpt$ebnf$1", "listRestOpt"], "postprocess": ([e, es, eʹ]) => [e, ...es, eʹ].reverse().reduce((e̅, e) => Expr.constr(ν(), str(Cons.name)(ν()), List.fromArray([e, e̅])))},
    {"name": "listRestOpt", "symbols": [], "postprocess": () => Expr.constr(ν(), str(Nil.name)(ν()), nil())},
    ...
    {"name": "pair_pattern", "symbols": ["pair_pattern$macrocall$1", "pattern", "pair_pattern$macrocall$3", "pattern", "pair_pattern$macrocall$5"], "postprocess": ([, mk_κ1, , mk_κ2, ,]) => (κ: Cont) => Trie.constr(singleton(str(Pair.name)(ν()), compose(mk_κ1, mk_κ2)(κ)))},
    ...
    {"name": "listOpt_pattern", "symbols": [], "postprocess": () => (κ: Cont) => Trie.constr(singleton(str(Nil.name)(ν()), κ))},
    {"name": "listOpt_pattern", "symbols": ["list1_pattern"], "postprocess": id},
    {"name": "list1_pattern", "symbols": ["pattern", "listRestOpt_pattern"], "postprocess": ([mk_κ1, mk_κ2]) => (κ: Cont) => Trie.constr(singleton(str(Cons.name)(ν()), compose(mk_κ1, mk_κ2)(κ)))},
    {"name": "listRestOpt_pattern", "symbols": [], "postprocess": () => (κ: Cont) => Trie.constr(singleton(str(Nil.name)(ν()), κ))},
