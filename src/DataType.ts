...
export function initDataTypes (): void {
   ...
   initDataType(new DataType("Rect", new Map([["Rect", ["x", "y", "width", "height"]]])))
   ...
   initDataType(new DataType("GraphicsElement", new Map([["PathStroke", ["points"]], ["RectFill", ["points"]], ["Translate", ["vec"]]])))
}
