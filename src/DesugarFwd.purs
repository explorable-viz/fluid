...
exprFwd (Record α xss)           = E.Record α <$> traverse (traverse exprFwd) (fromList xss)
...
patternFwd (PRecord xps) κ       = ElimRecord (xps <#> key # fromList) <$> recordPatternFwd (fromList xps) κ
