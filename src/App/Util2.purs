...
import Util2 (type (×), type (+), (×), (!), absurd, error, fromJust, successful, unimplemented)
...
selectCell α i j i' j' = Matrix false (insertMatrix i j (error unimplemented) (error unimplemented))
