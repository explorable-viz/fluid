...
(function($PS) {
  ...
  var showCtr = new Data_Show.Show(function (c) {
      var show$prime = function (str) {
          ...
          throw new Error("Failed pattern match at DataType (line 39, column 7 - line 41, column 48): " + [ str.constructor.name ]);
      };
  ...
  var ctr = function (dictFoldable) {
      return function (c) {
          var $36 = Data_Tuple.Tuple.create(c);
          var $37 = Data_List.fromFoldable(dictFoldable);
          return function ($38) {
              return $36($37($38));
          };
      };
  };
  var dataType = function (dictFunctor) {
      return function (dictFoldable) {
          return function (name) {
              var $39 = DataType.create(name);
              var $40 = Data_Map_Internal.fromFoldable(ordCtr)(dictFoldable);
              var $41 = Data_Functor.map(dictFunctor)(Data_Tuple.uncurry(ctr(dictFoldable)));
              return function ($42) {
                  return $39($40($41($42)));
              };
          };
  ...
  var cFalse = "False";
  var cCons = ":";
  var dataTypes = Data_List.fromFoldable(Data_Foldable.foldableArray)([ dataType(Data_Functor.functorArray)(Data_Foldable.foldableArray)("Bool")([ new Data_Tuple.Tuple(cTrue, [  ]), new Data_Tuple.Tuple(cFalse, [  ]) ]), dataType(Data_Functor.functorArray)(Data_Foldable.foldableArray)("List")([ new Data_Tuple.Tuple(cNil, [  ]), new Data_Tuple.Tuple(cCons, [ "head", "tail" ]) ]), dataType(Data_Functor.functorArray)(Data_Foldable.foldableArray)("Option")([ new Data_Tuple.Tuple("None", [  ]), new Data_Tuple.Tuple("Some", [ "x" ]) ]), dataType(Data_Functor.functorArray)(Data_Foldable.foldableArray)("Ordering")([ new Data_Tuple.Tuple("GT", [  ]), new Data_Tuple.Tuple("LT", [  ]), new Data_Tuple.Tuple("EQ", [  ]) ]), dataType(Data_Functor.functorArray)(Data_Foldable.foldableArray)("Pair")([ new Data_Tuple.Tuple("Pair", [ "fst", "snd" ]) ]), dataType(Data_Functor.functorArray)(Data_Foldable.foldableArray)("Tree")([ new Data_Tuple.Tuple("Empty", [  ]), new Data_Tuple.Tuple("NonEmpty", [ "left", "x", "right" ]) ]), dataType(Data_Functor.functorArray)(Data_Foldable.foldableArray)("Point")([ new Data_Tuple.Tuple("Point", [ "x", "y" ]) ]), dataType(Data_Functor.functorArray)(Data_Foldable.foldableArray)("Orient")([ new Data_Tuple.Tuple("Horiz", [  ]), new Data_Tuple.Tuple("Vert", [  ]) ]), dataType(Data_Functor.functorArray)(Data_Foldable.foldableArray)("GraphicsElement")([ new Data_Tuple.Tuple("Circle", [ "x", "y", "radius", "fill" ]), new Data_Tuple.Tuple("Group", [ "gs" ]), new Data_Tuple.Tuple("Line", [ "p1", "p2", "stroke", "strokeWidth" ]), new Data_Tuple.Tuple("Polyline", [ "points", "stroke", "strokeWidth" ]), new Data_Tuple.Tuple("Polymarkers", [ "points", "markers" ]), new Data_Tuple.Tuple("Rect", [ "x", "y", "width", "height", "fill" ]), new Data_Tuple.Tuple("Text", [ "x", "y", "str", "anchor", "baseline" ]), new Data_Tuple.Tuple("Viewport", [ "x", "y", "width", "height", "fill", "margin", "scale", "translate", "g" ]) ]), dataType(Data_Functor.functorArray)(Data_Foldable.foldableArray)("Transform")([ new Data_Tuple.Tuple("Scale", [ "x", "y" ]), new Data_Tuple.Tuple("Translate", [ "x", "y" ]) ]), dataType(Data_Functor.functorArray)(Data_Foldable.foldableArray)("Marker")([ new Data_Tuple.Tuple("Arrowhead", [  ]) ]) ]);
  ...
  var dataTypeForListCtr = new DataTypeFor(function (v) {
      ...
      throw new Error("Failed pattern match at DataType (line 77, column 1 - line 79, column 39): " + [ v.constructor.name ]);
  });
  ...
  var arity = function (c) {
      return Control_Bind.bind(Data_Either.bindEither)(dataTypeFor(dataTypeForCtr)(c))(function (v) {
          return Data_Functor.map(Data_Either.functorEither)(Data_List.length)(Data_Either.note(Util.absurd)(Data_Map_Internal.lookup(ordCtr)(c)(v.value1)));
      });
  };
...
(function($PS) {
  ...
  var simplePattern = function (pattern$prime) {
      ...
      return Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(listEmpty))(listNonEmpty))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(constr)))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)($$var)))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(token.parens(pattern$prime))))(pair);
  };
  var pattern = (function () {
      ...
      return Control_Lazy.fix(Text_Parsing_Parser.lazyParserT)((function () {
          var $22 = Text_Parsing_Parser_Expr.buildExprParser(Data_Identity.monadIdentity)(operators(infixCtr));
          return function ($23) {
              return $22(appChain_pattern($23));
          };
      })());
  })();
  ...
  var expr_ = (function () {
      var binaryOp = function (op) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(token.operator)(function (op$prime) {
              return Util.onlyIf(op === op$prime)(Text_Parsing_Parser.monadPlusParserT(Data_Identity.monadIdentity))((function () {
                  var $15 = DataType.isCtrOp(op$prime);
                  if ($15) {
                      return function (e) {
                          return function (e$prime) {
      ...
      var appChain = function (expr$prime) {
          var simpleExpr = (function () {
              ...
              var defsExpr = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function ($28) {
                  return Data_List.concat(Data_List_NonEmpty.toList($28));
  ...
  var module_ = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function ($31) {
      return SExpr.Module.create(Data_List.concat($31));
...
(function($PS) {
  ...
  var toPairPattern = new ToPair(function (v) {
      if (v instanceof SExpr.PConstr && (v.value1 instanceof Data_List_Types.Cons && (v.value1.value1 instanceof Data_List_Types.Cons && (v.value1.value1.value1 instanceof Data_List_Types.Nil && Data_Eq.eq(DataType.eqCtr)(v.value0)(DataType.cPair))))) {
          return new Data_Tuple.Tuple(v.value1.value0, v.value1.value1.value0);
      };
      return Util.error(Util.absurd);
  });
  var toPair = function (dict) {
      return dict.toPair;
  };
  var toList = function (dict) {
      return dict.toList;
  }; 
  var toListPattern = new ToList(function (v) {
      if (v instanceof SExpr.PConstr && (v.value1 instanceof Data_List_Types.Cons && (v.value1.value1 instanceof Data_List_Types.Cons && (v.value1.value1.value1 instanceof Data_List_Types.Nil && Data_Eq.eq(DataType.eqCtr)(v.value0)(DataType.cCons))))) {
          return new Data_List_Types.Cons(v.value1.value0, toList(toListPattern)(v.value1.value1.value0));
      };
      if (v instanceof SExpr.PConstr && (v.value1 instanceof Data_List_Types.Nil && Data_Eq.eq(DataType.eqCtr)(v.value0)(DataType.cNil))) {
          return Data_List_Types.Nil.value;
      };
      return Util.error(Util.absurd);
  });
  ...
  var prettyCtr = new Pretty((function () {
      var $268 = pretty(prettyString);
      var $269 = Data_Show.show(DataType.showCtr);
      return function ($270) {
          return $268($269($270));
      };
  })());
  var prettyP = function (dictPretty) {
      var $271 = pretty(dictPretty);
      return function ($272) {
          return Text_Pretty.render($271($272));
      };
  };
  ...
  var vert = function (dictFoldable) {
      return function (delim) {
          var vert$prime = function (v) {
              ...
              throw new Error("Failed pattern match at Pretty (line 96, column 10 - line 96, column 34): " + [ v.constructor.name ]);
          };
          var $273 = Data_List.fromFoldable(dictFoldable);
          return function ($274) {
              return vert$prime($273($274));
          };
      };
  };
  var nil = Text_Pretty.text(Parse.str.lBracket + Parse.str.rBracket);
  var hspace = function (dictFoldable) {
      var $275 = Text_Pretty.hcat(Data_List_Types.foldableList);
      var $276 = Util.intersperse(space);
      var $277 = Data_List.fromFoldable(dictFoldable);
      return function ($278) {
          return $275($276($277($278)));
      };
  };
  var hole = Text_Pretty.text("\u25a1");
  var comma = Text_Pretty.text(",");
  var hcomma = function (dictFoldable) {
      var $279 = Text_Pretty.hcat(Data_List_Types.foldableList);
      var $280 = Util.intersperse(Text_Pretty.beside(comma)(space));
      var $281 = Data_List.fromFoldable(dictFoldable);
      return function ($282) {
  ...
  var highlightIf = function (v) {
      ...
      throw new Error("Failed pattern match at Pretty (line 33, column 1 - line 33, column 35): " + [ v.constructor.name ]);
  };
  var parens = between(Text_Pretty.text("("))(Text_Pretty.text(")"));
  var prettyPair = function (dictPretty) {
      return function (v) {
          return parens(hcomma(Data_Foldable.foldableArray)([ pretty(dictPretty)(v.value0), pretty(dictPretty)(v.value1) ]));
      };
  };
  var prettyParensOpt = function (dictPretty) {
      return function (x) {
          var doc = pretty(dictPretty)(x);
          var $103 = Data_String_CodeUnits.contains(" ")(Text_Pretty.render(doc));
          if ($103) {
              return parens(doc);
          };
          return doc;
  ...
  var prettyPattern = new Pretty(function (v) {
      if (v instanceof SExpr.PVar) {
          return Text_Pretty.text(v.value0);
      };
      if (v instanceof SExpr.PConstr) {
          if (Data_Eq.eq(DataType.eqCtr)(v.value0)(DataType.cNil) || Data_Eq.eq(DataType.eqCtr)(v.value0)(DataType.cCons)) {
              return prettyList(prettyPattern)(toList(toListPattern)(v));
          };
          if (Data_Eq.eq(DataType.eqCtr)(v.value0)(DataType.cPair)) {
              return prettyPair(prettyPattern)(toPair(toPairPattern)(v));
          };
          if (Data_Boolean.otherwise) {
              return prettyConstr(prettyPattern)(v.value0)(v.value1);
          };
      };
      if (v instanceof SExpr.PListEmpty) {
          return nil;
      ...
      if (v instanceof SExpr.PListNonEmpty) {
          return Text_Pretty.beside(Text_Pretty.beside(Text_Pretty.text(Parse.str.lBracket))(pretty(prettyPattern)(v.value0)))(pretty(prettyListPatternRest)(v.value1));
      };
      throw new Error("Failed pattern match at Pretty (line 236, column 1 - line 243, column 81): " + [ v.constructor.name ]);
  });
  var prettyListPatternRest = new Pretty(function (v) {
      if (v instanceof SExpr.PEnd) {
          return Text_Pretty.text(Parse.str.rBracket);
      };
      if (v instanceof SExpr.PNext) {
          return hspace(Data_Foldable.foldableArray)([ comma, Text_Pretty.beside(pretty(prettyPattern)(v.value0))(pretty(prettyListPatternRest)(v.value1)) ]);
      };
      throw new Error("Failed pattern match at Pretty (line 254, column 1 - line 256, column 65): " + [ v.constructor.name ]);
  });
  var prettySVarDef = new Pretty(function (v) {
      return hspace(Data_Foldable.foldableArray)([ pretty(prettyPattern)(v.value0), Text_Pretty.text(Parse.str.equals), pretty(prettySExpr)(v.value1) ]);
  });
  var prettySExpr = new Pretty(function (v) {
      if (v instanceof SExpr.Var) {
          return Text_Pretty.text(v.value0);
      };
      if (v instanceof SExpr.Op) {
          return parens(Text_Pretty.text(v.value0));
      };
      if (v instanceof SExpr.Int) {
      ...
      if (v instanceof SExpr.Constr) {
          return prettyConstr(prettySExpr)(v.value1)(v.value2);
      };
      if (v instanceof SExpr.Matrix) {
          var quant = [ parens(hcomma(Data_Foldable.foldableArray)([ Text_Pretty.text(v.value2.value0), Text_Pretty.text(v.value2.value1) ])), Text_Pretty.text(Parse.str.in_), pretty(prettySExpr)(v.value3), Text_Pretty.text(Parse.str.arrayRBracket) ];
          var init = [ Text_Pretty.text(Parse.str.arrayLBracket), pretty(prettySExpr)(v.value1), Text_Pretty.text(Parse.str.bar) ];
          return highlightIf(v.value0)(hspace(Data_Foldable.foldableArray)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(init)(quant)));
      };
      if (v instanceof SExpr.Lambda) {
          return Text_Pretty.beside(Text_Pretty.text(Parse.str.fun))(vert(Data_List_Types.foldableNonEmptyList)(semi)(Data_Functor.map(Data_List_Types.functorNonEmptyList)(pretty(prettySBranch))(v.value0)));
      };
      if (v instanceof SExpr.App) {
          return hspace(Data_Foldable.foldableArray)([ pretty(prettySExpr)(v.value0), pretty(prettySExpr)(v.value1) ]);
      };
      if (v instanceof SExpr.BinaryApp) {
          return parens(hspace(Data_Foldable.foldableArray)([ pretty(prettySExpr)(v.value0), Text_Pretty.text(v.value1), pretty(prettySExpr)(v.value2) ]));
      };
      if (v instanceof SExpr.MatchAs) {
          return Text_Pretty.atop(hspace(Data_Foldable.foldableArray)([ Text_Pretty.text(Parse.str.match), pretty(prettySExpr)(v.value0), Text_Pretty.text(Parse.str.as) ]))(vert(Data_List_Types.foldableNonEmptyList)(semi)(Data_Functor.map(Data_List_Types.functorNonEmptyList)(pretty(prettyPatternExpr))(v.value1)));
      };
      if (v instanceof SExpr.IfElse) {
          return hspace(Data_Foldable.foldableArray)([ Text_Pretty.text(Parse.str.if_), pretty(prettySExpr)(v.value0), Text_Pretty.text(Parse.str.then_), pretty(prettySExpr)(v.value1), Text_Pretty.text(Parse.str.else_), pretty(prettySExpr)(v.value2) ]);
      };
      if (v instanceof SExpr.ListEmpty) {
          return highlightIf(v.value0)(nil);
      };
      if (v instanceof SExpr.ListNonEmpty) {
          return Text_Pretty.beside(Text_Pretty.beside(highlightIf(v.value0)(Text_Pretty.text(Parse.str.lBracket)))(pretty(prettySExpr)(v.value1)))(pretty(prettyListRest)(v.value2));
      };
      if (v instanceof SExpr.ListEnum) {
          return brackets(hspace(Data_Foldable.foldableArray)([ pretty(prettySExpr)(v.value0), Text_Pretty.text(Parse.str.ellipsis), pretty(prettySExpr)(v.value1) ]));
      };
      if (v instanceof SExpr.ListComp) {
          return brackets(hspace(Data_Foldable.foldableArray)([ pretty(prettySExpr)(v.value1), Text_Pretty.text(Parse.str.bar), hcomma(Data_List_Types.foldableNonEmptyList)(Data_Functor.map(Data_List_Types.functorNonEmptyList)(pretty(prettyQualifier))(v.value2)) ]));
      };
      if (v instanceof SExpr.Let) {
          return Text_Pretty.atop(hspace(Data_Foldable.foldableArray)([ Text_Pretty.text(Parse.str.let_), vert(Data_List_Types.foldableNonEmptyList)(semi)(Data_Functor.map(Data_List_Types.functorNonEmptyList)(pretty(prettySVarDef))(v.value0)) ]))(hspace(Data_Foldable.foldableArray)([ Text_Pretty.text(Parse.str.in_), pretty(prettySExpr)(v.value1) ]));
      };
      if (v instanceof SExpr.LetRec) {
          return Text_Pretty.atop(hspace(Data_Foldable.foldableArray)([ Text_Pretty.text(Parse.str.let_), vert(Data_List_Types.foldableNonEmptyList)(semi)(Data_Functor.map(Data_List_Types.functorNonEmptyList)(pretty(prettyClause))(v.value0)) ]))(hspace(Data_Foldable.foldableArray)([ Text_Pretty.text(Parse.str.in_), pretty(prettySExpr)(v.value1) ]));
      };
      throw new Error("Failed pattern match at Pretty (line 186, column 1 - line 210, column 80): " + [ v.constructor.name ]);
  });
  var prettySBranch = new Pretty(function (v) {
      return hspace(Data_List_Types.foldableList)(Data_Semigroup.append(Data_List_Types.semigroupList)(Data_Functor.map(Data_List_Types.functorList)(pretty(prettyPattern))(Data_List_NonEmpty.toList(v.value0)))(new Data_List_Types.Cons(Text_Pretty.text(Parse.str.equals), new Data_List_Types.Cons(pretty(prettySExpr)(v.value1), Data_List_Types.Nil.value))));
  });
  var prettyQualifier = new Pretty(function (v) {
      if (v instanceof SExpr.Guard) {
          return pretty(prettySExpr)(v.value0);
      };
      if (v instanceof SExpr.Generator) {
          return hspace(Data_Foldable.foldableArray)([ pretty(prettyPattern)(v.value0), Text_Pretty.text(Parse.str.lArrow), pretty(prettySExpr)(v.value1) ]);
      };
      if (v instanceof SExpr.Declaration) {
          return hspace(Data_Foldable.foldableArray)([ Text_Pretty.text(Parse.str.let_), pretty(prettyPattern)(v.value0.value0), Text_Pretty.text(Parse.str.equals), pretty(prettySExpr)(v.value0.value1) ]);
      };
      throw new Error("Failed pattern match at Pretty (line 228, column 1 - line 231, column 104): " + [ v.constructor.name ]);
  });
  var prettyPatternExpr = new Pretty(function (v) {
      return Text_Pretty.beside(Text_Pretty.beside(pretty(prettyPattern)(v.value0))(Text_Pretty.text(Parse.str.lArrow)))(pretty(prettySExpr)(v.value1));
  });
  var prettyListRest = new Pretty(function (v) {
      if (v instanceof SExpr.End) {
          return highlightIf(v.value0)(Text_Pretty.text(Parse.str.rBracket));
      };
      if (v instanceof SExpr.Next) {
          return hspace(Data_Foldable.foldableArray)([ highlightIf(v.value0)(comma), Text_Pretty.beside(pretty(prettySExpr)(v.value1))(pretty(prettyListRest)(v.value2)) ]);
      };
      throw new Error("Failed pattern match at Pretty (line 212, column 1 - line 214, column 82): " + [ v.constructor.name ]);
  });
  var prettyClause = new Pretty(function (v) {
      return hspace(Data_Foldable.foldableArray)([ Text_Pretty.text(v.value0), pretty(prettySBranch)(v.value1) ]);
  });
  var prettyVal = new Pretty(function (v) {
      ...
      if (v instanceof Val.Matrix) {
          return vert(Data_Foldable.foldableArray)(comma)(Data_Functor.map(Data_Functor.functorArray)((function () {
              var $283 = hcomma(Data_Foldable.foldableArray);
              var $284 = Data_Functor.map(Data_Functor.functorArray)(pretty(prettyVal));
              return function ($285) {
                  return $283($284($285));
              };
      ...
      throw new Error("Failed pattern match at Pretty (line 165, column 1 - line 175, column 59): " + [ v.constructor.name ]);
  });
  exports["prettyP"] = prettyP;
  exports["prettyVal"] = prettyVal;
  exports["prettySExpr"] = prettySExpr;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  ...
  var union1 = function (v) {
      return function (v1) {
          return function (v2) {
              ...
              throw new Error("Failed pattern match at Primitive (line 213, column 1 - line 213, column 71): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
  ...
  var toFromBoolean = new ToFrom(function (v) {
      ...
      throw new Error("Failed pattern match at Primitive (line 101, column 1 - line 110, column 30): " + [ v.constructor.name ]);
  }, function (v) {
  ...
  var toFromIntOrNumber = new ToFrom(function (v) {
      ...
      throw new Error("Failed pattern match at Primitive (line 58, column 1 - line 66, column 75): " + [ v.constructor.name ]);
  }, function (v) {
  ...
  var toFromIntOrNumberOrString = new ToFrom(function (v) {
      ...
      throw new Error("Failed pattern match at Primitive (line 68, column 1 - line 78, column 79): " + [ v.constructor.name ]);
  }, function (v) {
  ...
  var unwrap = function (dictToFrom) {
      var $317 = match(dictToFrom);
      return function ($318) {
          return Data_Tuple.fst($317($318));
      };
  };
          ...
          return function (v) {
              var apply_fwd = function (dictPartial) {
                  return function (v1) {
                      ...
                      throw new Error("Failed pattern match at Primitive (line 155, column 4 - line 155, column 70): " + [ v1.constructor.name ]);
                  };
              };
              var apply_bwd = function (dictPartial) {
                  return function (v1) {
                      return function (v2) {
                          ...
                          throw new Error("Failed pattern match at Primitive (line 158, column 4 - line 158, column 92): " + [ v1.constructor.name, v2.constructor.name ]);
                      };
                  };
              };
              var apply = function (dictPartial) {
                  return function (v1) {
                      ...
                      throw new Error("Failed pattern match at Primitive (line 152, column 4 - line 152, column 53): " + [ v1.constructor.name ]);
                  };
              };
              ...
              return function (v) {
                  var apply_fwd = function (dictPartial) {
                      return function (v1) {
                          ...
                          throw new Error("Failed pattern match at Primitive (line 173, column 4 - line 173, column 78): " + [ v1.constructor.name ]);
                      };
                  };
                  var apply_bwd = function (dictPartial) {
                      return function (v1) {
                          return function (v2) {
                              ...
                              throw new Error("Failed pattern match at Primitive (line 176, column 4 - line 176, column 95): " + [ v1.constructor.name, v2.constructor.name ]);
                          };
                      };
                  };
                  var apply = function (dictPartial) {
                      return function (v1) {
                          ...
                          throw new Error("Failed pattern match at Primitive (line 170, column 4 - line 170, column 56): " + [ v1.constructor.name ]);
                      };
                  };
                  return Data_Function.flip(Val.Primitive.create)(Data_List_Types.Nil.value)({
                      arity: 2,
                  ...
                  var fwd$prime = function (v1) {
                      return function (v2) {
                          return new Data_Tuple.Tuple(v.fwd(v1.value0)(v2.value0), (function () {
                              var $268 = isZero(dictIsZero)(v1.value0);
                              if ($268) {
                                  return v1.value1;
                              };
                              var $269 = isZero(dictIsZero)(v2.value0);
                              if ($269) {
                                  return v2.value1;
                              };
                      ...
                      return function (v1) {
                          return function (v2) {
                              return function (v3) {
                                  ...
                                  throw new Error("Failed pattern match at Primitive (line 218, column 1 - line 219, column 73): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name, v3.constructor.name ]);
                              };
                          };
                      };
                  };
...
(function($PS) {
  ...
  var matchArgs = function (v) {
      return function (v1) {
          return function (v2) {
              if (v1 instanceof Data_List_Types.Nil) {
                  return Control_Applicative.pure(Data_Either.applicativeEither)(new Data_Tuple.Tuple(new Data_Tuple.Tuple(Bindings.Empty.value, v2), Data_List_Types.Nil.value));
              };
              if (v1 instanceof Data_List_Types.Cons && v2 instanceof Expr.ContElim) {
                  return Control_Bind.bind(Data_Either.bindEither)(match(v1.value0)(v2.value0))(function (v4) {
                      return Control_Bind.bind(Data_Either.bindEither)(matchArgs(v)(v1.value1)(v4.value0.value1))(function (v5) {
                          return Control_Applicative.pure(Data_Either.applicativeEither)(new Data_Tuple.Tuple(new Data_Tuple.Tuple(Data_Semigroup.append(Bindings.semigroupBindings)(v4.value0.value0)(v5.value0.value0), v5.value0.value1), new Data_List_Types.Cons(v4.value1, v5.value1)));
                      });
                  });
              };
      ...
      return function (v1) {
          ...
          if (v1 instanceof Expr.ElimVar) {
              if (v1.value0 === Bindings.varAnon) {
                  return Control_Applicative.pure(Data_Either.applicativeEither)(new Data_Tuple.Tuple(new Data_Tuple.Tuple(Bindings.Empty.value, v1.value1), new Expl.MatchVarAnon(v2)));
              };
              if (Data_Boolean.otherwise) {
                  return Control_Applicative.pure(Data_Either.applicativeEither)(new Data_Tuple.Tuple(new Data_Tuple.Tuple(new Bindings.Extend(Bindings.Empty.value, new Bindings.Binding(v1.value0, v2)), v1.value1), new Expl.MatchVar(v1.value0)));
              };
          };
          if (v instanceof Val.Constr && v1 instanceof Expr.ElimConstr) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Data_Either.bindEither)(Lattice.checkConsistent(DataType.keyCtr)("Pattern mismatch: ")(v.value1)(Data_Map_Internal.keys(v1.value0)))(function () {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Incomplete patterns: no branch for " + Data_Show.show(DataType.showCtr)(v.value1))(Data_Map_Internal.lookup(DataType.ordCtr)(v.value1)(v1.value0)))(function (κ) {
                      return Control_Bind.bind(Data_Either.bindEither)(matchArgs(v.value1)(v.value2)(κ))(function (v2) {
                          return Control_Applicative.pure(Data_Either.applicativeEither)(new Data_Tuple.Tuple(new Data_Tuple.Tuple(v2.value0.value0, v2.value0.value1), new Expl.MatchConstr(v.value1, v2.value1, Data_List.difference(DataType.eqCtr)(Data_Map_Internal.keys(v1.value0))(Data_List.singleton(v.value1)))));
                      });
                  });
              });
          };
          if (v1 instanceof Expr.ElimConstr) {
              return Control_Bind.bind(Data_Either.bindEither)(DataType.dataTypeFor(DataType.dataTypeForListCtr)(Data_Map_Internal.keys(v1.value0)))(function (d) {
                  return Util.report("Pattern mismatch: " + (Pretty.prettyP(Pretty.prettyVal)(v) + (" is not a constructor value, expected " + Data_Show.show(DataType.showDataType)(d))));
              });
          };
          throw new Error("Failed pattern match at Eval (line 23, column 1 - line 23, column 63): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var closeDefs = function (v) {
      return function (v1) {
          return function (v2) {
              if (v2 instanceof Bindings.Empty) {
                  return Bindings.Empty.value;
              };
              if (v2 instanceof Bindings.Extend) {
                  return new Bindings.Extend(closeDefs(v)(v1)(v2.value0), new Bindings.Binding(v2.value1.value0, new Val.Closure(v, v1, v2.value1.value1)));
              };
              throw new Error("Failed pattern match at Eval (line 47, column 1 - line 47, column 54): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
  var checkArity = function (c) {
      ...
      return function (v) {
          ...
          if (v instanceof Expr.Matrix) {
              var unzipToArray = (function () {
                  var $184 = Data_Bifunctor.bimap(Data_Tuple.bifunctorTuple)(Data_Array.fromFoldable(Data_List_Types.foldableList))(Data_Array.fromFoldable(Data_List_Types.foldableList));
                  return function ($185) {
                      return $184(Data_List.unzip($185));
                  };
              })();
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Data_Either.bindEither)(Util.check(Data_Ord.greaterThanOrEq(Data_Tuple.ordTuple(Data_Ord.ordInt)(Data_Ord.ordInt))(new Data_Tuple.Tuple(v3.value0.value0, v3.value1.value0))(new Data_Tuple.Tuple(1, 1)))("array must be at least (" + (Data_Show.show(Data_Tuple.showTuple(Data_Show.showInt)(Data_Show.showInt))(new Data_Tuple.Tuple(1, 1)) + ("); got (" + (Data_Show.show(Data_Tuple.showTuple(Data_Show.showInt)(Data_Show.showInt))(new Data_Tuple.Tuple(v3.value0.value0, v3.value1.value0)) + ")")))))(function () {
                          return Control_Bind.bind(Data_Either.bindEither)(Data_Functor.map(Data_Either.functorEither)(Data_Functor.map(Data_Functor.functorFn)(unzipToArray)(Data_Functor.map(Data_List_Types.functorList)(unzipToArray)))(Data_Traversable.sequence(Data_List_Types.traversableList)(Data_Either.applicativeEither)(Control_Bind.bind(Data_List_Types.bindList)(Data_List.range(1)(v3.value0.value0))(function (i) {
                              return Data_List.singleton(Data_Traversable.sequence(Data_List_Types.traversableList)(Data_Either.applicativeEither)(Control_Bind.bind(Data_List_Types.bindList)(Data_List.range(1)(v3.value1.value0))(function (j) {
                                  return Data_List.singleton($$eval(new Bindings.Extend(new Bindings.Extend(ρ, new Bindings.Binding(v.value2.value0, new Val.Int(false, i))), new Bindings.Binding(v.value2.value1, new Val.Int(false, j))))(v.value1));
                              })));
                          }))))(function (v4) {
          ...
          if (v instanceof Expr.LetRec) {
              ...
              return Control_Bind.bind(Data_Either.bindEither)($$eval(Data_Semigroup.append(Bindings.semigroupBindings)(ρ)(ρ$prime))(v.value1))(function (v1) {
          ...
          if (v instanceof Expr.Lambda) {
              return Control_Applicative.pure(Data_Either.applicativeEither)(new Data_Tuple.Tuple(new Expl.Lambda(ρ, v.value0), new Val.Closure(ρ, Bindings.Empty.value, v.value0)));
          };
                  ...
                  return Control_Bind.bind(Data_Either.bindEither)($$eval(ρ)(v.value1))(function (v3) {
                      ...
                      if (v1.value1 instanceof Val.Closure) {
                          ...
                          return Control_Bind.bind(Data_Either.bindEither)(match(v3.value1)(v1.value1.value2))(function (v4) {
                              return Control_Bind.bind(Data_Either.bindEither)($$eval(Data_Semigroup.append(Bindings.semigroupBindings)(v1.value1.value0)(Data_Semigroup.append(Bindings.semigroupBindings)(ρ2)(v4.value0.value0)))(Expr.asExpr(v4.value0.value1)))(function (v5) {
                      ...
                      if (v1.value1 instanceof Val.Primitive) {
                          ...
                          var v$prime$prime = (function () {
                              var $136 = v1.value1.value0.arity > Data_List.length(vs$prime);
                              if ($136) {
          ...
          if (v instanceof Expr.Let) {
              return Control_Bind.bind(Data_Either.bindEither)($$eval(ρ)(v.value0.value1))(function (v1) {
                  return Control_Bind.bind(Data_Either.bindEither)(match(v1.value1)(v.value0.value0))(function (v3) {
                      return Control_Bind.bind(Data_Either.bindEither)($$eval(Data_Semigroup.append(Bindings.semigroupBindings)(ρ)(v3.value0.value0))(v.value1))(function (v4) {
          ...
          throw new Error("Failed pattern match at Eval (line 56, column 1 - line 56, column 52): " + [ ρ.constructor.name, v.constructor.name ]);
      };
  };
          ...
          if (v.value0 instanceof Data_List_Types.Cons && v.value0.value0 instanceof Data_Either.Left) {
              return Control_Bind.bind(Data_Either.bindEither)($$eval(ρ)(v.value0.value0.value0.value1))(function (v1) {
                  return Control_Bind.bind(Data_Either.bindEither)(match(v1.value1)(v.value0.value0.value0.value0))(function (v3) {
                      return eval_module(Data_Semigroup.append(Bindings.semigroupBindings)(ρ)(v3.value0.value0))(new Expr.Module(v.value0.value1));
                  });
              });
          };
          if (v.value0 instanceof Data_List_Types.Cons && v.value0.value0 instanceof Data_Either.Right) {
              return eval_module(Data_Semigroup.append(Bindings.semigroupBindings)(ρ)(closeDefs(ρ)(v.value0.value0.value0)(v.value0.value0.value0)))(new Expr.Module(v.value0.value1));
          };
...
(function($PS) {
  ...
  var openDatasetAs = function (file) {
      return function (x) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Control_Bind.bind(Effect_Aff.bindAff)(loadFile("fluid")(file))(parseWithDefaultImports))(function (v) {
              var v1 = Util.successful(Control_Bind.bind(Data_Either.bindEither)(DesugarFwd.desugarFwd(v.value1))(Eval["eval"](v.value0)));
              return Control_Applicative.pure(Effect_Aff.applicativeAff)(new Bindings.Extend(Bindings.Empty.value, new Bindings.Binding(x, v1.value1)));
          });
      };
  };
...
(function($PS) {
  ...
  exports["modifyAroundAction"] = modifyAroundAction;
  exports["treeBifunctor"] = treeBifunctor;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
...
(function($PS) {
  ...
  var Util = $PS["Util"];
  var Val = $PS["Val"];                
  var run = Test_Spec_Mocha.runMocha;

  // Don't enforce expected values for graphics tests (values too complex).
  var isGraphical = function (v) {
      if (v instanceof Val.Hole) {
          return false;
      };
      if (v instanceof Val.Constr) {
          return DataType.typeName(Util.successful(DataType.dataTypeFor(DataType.dataTypeForCtr)(v.value1))) === "GraphicsElement";
      };
      return false;
  };
  ...
  var checkPretty = function (dictPretty) {
      return function (x) {
          return function (expected) {
              return Test_Spec_Assertions.shouldEqual(Effect_Aff.monadThrowAff)(Data_Show.showString)(Data_Eq.eqString)(Pretty.prettyP(dictPretty)(x))(expected);
          };
      };
  };
  var testLink = function (file) {
      return function (v1_sel) {
          return function (v2_expect) {
              var name = "linking/" + file;
              var setup = Control_Bind.bind(Effect_Aff.bindAff)(Module.openWithDefaultImports(name + "-1"))(function (v) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Module.openWithDefaultImports(name + "-2"))(function (v1) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Module.openDatasetAs("example/" + (name + "-data"))("data"))(function (ρ) {
                          return Control_Applicative.pure(Effect_Aff.applicativeAff)(new Data_Tuple.Tuple(new Data_Tuple.Tuple(new Data_Tuple.Tuple(v.value0, ρ), v.value1), v1.value1));
                      });
                  });
              });
              return Test_Spec.before(Effect.monadEffect)(Effect_Aff.monadAff)(setup)(Test_Spec.it(Effect.monadEffect)(Test_Spec.exampleFunc)(name)(function (v) {
                  var e2 = Util.successful(DesugarFwd.desugarFwd(v.value1));
                  var e1 = Util.successful(DesugarFwd.desugarFwd(v.value0.value1));
                  var v1 = Util.successful(Eval["eval"](Data_Semigroup.append(Bindings.semigroupBindings)(v.value0.value0.value0)(v.value0.value0.value1))(e1));
                  var v2 = Util.successful(Eval["eval"](Data_Semigroup.append(Bindings.semigroupBindings)(v.value0.value0.value0)(v.value0.value0.value1))(e2));
                  var v3 = EvalBwd.evalBwd(v1_sel)(v1.value0);
                  var v4 = Bindings.splitAt(1)(v3.value0.value0);
  ...
  var v2$prime = Lattice.neg(Val.joinSemilatticeVal)(EvalFwd.evalFwd(Data_Semigroup.append(Bindings.semigroupBindings)(Lattice.neg(Bindings.joinSemilatticeBindings(Val.functorVal)(Lattice.joinSemilatticeBoolean)(Val.slicesVal))(Lattice.botOf(Bindings.boundedSlices(Val.functorVal)(Val.boundedSlices))(v.value0.value0.value0)))(Lattice.neg(Bindings.joinSemilatticeBindings(Val.functorVal)(Lattice.joinSemilatticeBoolean)(Val.slicesVal))(v4.value1)))(Data_Functor.map(Expr.functorExpr)(Data_Function["const"](true))(e2))(true)(v2.value0));
                  return checkPretty(Pretty.prettyVal)(v2$prime)(v2_expect);
              }));
          };
      };
  };
  ...
  var testWithSetup = function (name) {
      return function (v_expect) {
          return function (v_opt) {
              return function (setup) {
                  return Test_Spec.before(Effect.monadEffect)(Effect_Aff.monadAff)(setup)(Test_Spec.it(Effect.monadEffect)(Test_Spec.exampleFunc)(name)(function (v) {
                      var v1 = Util.successful(desugarEval(v.value0)(v.value1));
                      var v3 = desugarEval_bwd(new Data_Tuple.Tuple(v1.value0, v.value1))(Data_Maybe.fromMaybe(v1.value1)(v_opt));
                      var v4 = desugarEval_fwd(v3.value0)(v3.value1)(v1.value0);
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Control_Applicative.unless(Effect_Aff.applicativeAff)(isGraphical(v4))(checkPretty(Pretty.prettyVal)(v4)(v_expect)))(function () {
                          if (v_opt instanceof Data_Maybe.Nothing) {
                              return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Unit.unit);
                          };
                          if (v_opt instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(Effect_Aff.bindAff)(Module.loadFile("fluid/example")(name + ".expect"))(checkPretty(Pretty.prettySExpr)(v3.value1));
                          };
                          throw new Error("Failed pattern match at Test.Util (line 62, column 10 - line 64, column 86): " + [ v_opt.constructor.name ]);
                      });
                  }));
              };
          };
  ...
  var test = function (file) {
      return function (expected) {
          return testWithSetup(file)(expected)(Data_Maybe.Nothing.value)(Module.openWithDefaultImports(file));
      };
  };
  var testBwd = function (file) {
      return function (v) {
          return function (expected) {
              var name = "slicing/" + file;
              return testWithSetup(name)(expected)(new Data_Maybe.Just(v))(Module.openWithDefaultImports(name));
          };
      };
  };
  var testWithDataset = function (dataset) {
      return function (file) {
          return testWithSetup(file)("")(Data_Maybe.Nothing.value)(Data_Functor.mapFlipped(Effect_Aff.functorAff)(Data_Bitraversable.bitraverse(Data_Tuple.bitraversableTuple)(Effect_Aff.applicativeAff)(Data_Tuple.uncurry(Module.openDatasetAs))(Module.openWithDefaultImports)(new Data_Tuple.Tuple(new Data_Tuple.Tuple("dataset/" + dataset, "data"), file)))(function (v) {
              return new Data_Tuple.Tuple(Data_Semigroup.append(Bindings.semigroupBindings)(v.value0)(v.value1.value0), v.value1.value1);
          }));
      };
  };
  exports["run"] = run;
  exports["test"] = test;
  exports["testBwd"] = testBwd;
  exports["testLink"] = testLink;
  exports["testWithDataset"] = testWithDataset;
})(PS);
(function($PS) {
  "use strict";
  ...
  var Val = $PS["Val"];                
  var test_scratchpad = [  ];
  var test_misc = [ Test_Util.test("arithmetic")("42"), Test_Util.test("array")("(1, (3, 3))"), Test_Util.test("compose")("5"), Test_Util.test("div-mod-quot-rem")("[[1, -1, -2, 2], [2, 2, 1, 1], [1, -1, -1, 1], [2, 2, -2, -2]]"), Test_Util.test("factorial")("40320"), Test_Util.test("filter")("[8, 7]"), Test_Util.test("flatten")("[(3, \"simon\"), (4, \"john\"), (6, \"sarah\"), (7, \"claire\")]"), Test_Util.test("foldr_sumSquares")("661"), Test_Util.test("lexicalScoping")("\"6\""), Test_Util.test("length")("2"), Test_Util.test("lookup")("Some \"sarah\""), Test_Util.test("map")("[5, 7, 13, 15, 4, 3, -3]"), Test_Util.test("mergeSort")("[1, 2, 3]"), Test_Util.test("normalise")("(33, 66)"), Test_Util.test("pattern-match")("4"), Test_Util.test("range")("[(0, 0), (0, 1), (1, 0), (1, 1)]"), Test_Util.test("reverse")("[2, 1]"), Test_Util.test("zipWith")("[[10], [12], [20]]") ];
  var test_graphics = [ Test_Util.testWithDataset("renewables-restricted")("graphics/background"), Test_Util.testWithDataset("renewables-restricted")("graphics/grouped-bar-chart"), Test_Util.testWithDataset("renewables-restricted")("graphics/line-chart"), Test_Util.testWithDataset("renewables-restricted")("graphics/stacked-bar-chart") ];
  var test_desugaring = [ Test_Util.test("desugar/list-comp-1")("[14, 12, 10, 13, 11, 9, 12, 10, 8]"), Test_Util.test("desugar/list-comp-2")("[14, 14, 14, 12, 12, 12, 10, 10, 10, 13, 13, 13, 11, 11, 11, 9, 9, 9, 12, 12, 12, 10, 10, 10, 8, 8, 8]"), Test_Util.test("desugar/list-comp-3")("[9, 8]"), Test_Util.test("desugar/list-comp-4")("[5, 4, 3]"), Test_Util.test("desugar/list-comp-5")("[5, 4, 3]"), Test_Util.test("desugar/list-comp-6")("[5]"), Test_Util.test("desugar/list-comp-7")("[[]]"), Test_Util.test("desugar/list-enum")("[3, 4, 5, 6, 7]") ];
  var pair = function (α) {
      return function (v1) {
          return function (v2) {
              return new Val.Constr(α, DataType.cPair, new Data_List_Types.Cons(v1, new Data_List_Types.Cons(v2, Data_List_Types.Nil.value)));
          };
      };
  };
  var test_slicing = [ Test_Util.testBwd("add")(new Val.Int(true, 8))("_8_"), Test_Util.testBwd("array-lookup")(new Val.Int(true, 14))("_14_"), Test_Util.testBwd("array-dims")(pair(true)(new Val.Int(true, 3))(new Val.Int(true, 3)))("(_3_, _3_)"), Test_Util.testBwd("conv-extend")(new Val.Matrix(true, Val.insertMatrix(1)(1)(new Val.Hole(true))(Val.holeMatrix(5)(5))))("_40.22222222222222_, 32.111111111111114, 22.88888888888889, 30.444444444444443, 37.888888888888886,\x0a36.22222222222222, 30.333333333333332, 30.22222222222222, 29.666666666666668, 33.111111111111114,\x0a28.555555555555557, 28.0, 34.666666666666664, 20.11111111111111, 20.333333333333332,\x0a21.77777777777778, 25.555555555555557, 28.88888888888889, 28.333333333333332, 27.333333333333332,\x0a13.666666666666666, 24.77777777777778, 27.22222222222222, 22.11111111111111, 29.444444444444443"), Test_Util.testBwd("conv-wrap")(new Val.Matrix(true, Val.insertMatrix(1)(1)(new Val.Hole(true))(Val.holeMatrix(5)(5))))("_32.333333333333336_, 30.333333333333332, 25.88888888888889, 27.0, 29.22222222222222,\x0a30.77777777777778, 30.333333333333332, 30.22222222222222, 29.666666666666668, 32.55555555555556,\x0a34.0, 28.0, 34.666666666666664, 20.11111111111111, 24.444444444444443,\x0a23.22222222222222, 25.555555555555557, 28.88888888888889, 28.333333333333332, 25.22222222222222,\x0a26.11111111111111, 30.555555555555557, 26.11111111111111, 19.666666666666668, 28.77777777777778"), Test_Util.testBwd("conv-zero")(new Val.Matrix(true, Val.insertMatrix(1)(1)(new Val.Hole(true))(Val.holeMatrix(5)(5))))("_18.666666666666668_, 20.22222222222222, 14.666666666666666, 20.555555555555557, 18.11111111111111,\x0a25.333333333333332, 30.333333333333332, 30.22222222222222, 29.666666666666668, 25.22222222222222,\x0a22.555555555555557, 28.0, 34.666666666666664, 20.11111111111111, 17.11111111111111,\x0a16.88888888888889, 25.555555555555557, 28.88888888888889, 28.333333333333332, 20.77777777777778,\x0a10.444444444444445, 21.0, 19.0, 15.0, 19.333333333333332"), Test_Util.testBwd("divide")(new Val.Hole(true))("_40.22222222222222_"), Test_Util.testBwd("map")(new Val.Constr(true, DataType.cCons, new Data_List_Types.Cons(new Val.Hole(false), new Data_List_Types.Cons(new Val.Constr(true, DataType.cCons, new Data_List_Types.Cons(new Val.Hole(false), new Data_List_Types.Cons(new Val.Hole(false), Data_List_Types.Nil.value))), Data_List_Types.Nil.value))))("[5, 6]"), Test_Util.testBwd("multiply")(new Val.Int(true, 0))("_0_"), Test_Util.testBwd("nth")(new Val.Int(true, 4))("_4_") ];

  // TODO: move to common location.
  var hole = new Val.Hole(false);
  var test_linking = [ Test_Util.testLink("pairs")(pair(false)(hole)(pair(false)(hole)(pair(false)(new Val.Int(true, 3))(hole))))("(3, (_5_, _7_))"), Test_Util.testLink("convolution")(new Val.Matrix(true, Val.insertMatrix(2)(2)(new Val.Hole(true))(Val.holeMatrix(5)(5))))("_14.333333333333334_, _11.222222222222221_, _8.0_, 7.888888888888889, 15.333333333333334,\x0a_20.77777777777778_, _13.11111111111111_, _19.444444444444443_, 9.88888888888889, 19.22222222222222,\x0a_18.444444444444443_, _12.0_, _24.555555555555557_, 10.0, 12.222222222222221,\x0a11.555555555555555, 15.222222222222221, 16.77777777777778, 10.333333333333334, 17.333333333333332,\x0a4.555555555555555, 14.11111111111111, 13.333333333333334, 5.444444444444445, 17.555555555555557") ];
  var tests = [ test_desugaring, test_misc, test_slicing, test_linking, test_graphics ];

  //tests = [ test_linking ]
  var main = Data_Functor["void"](Effect.functorEffect)(Data_Traversable.sequence(Data_Traversable.traversableArray)(Effect.applicativeEffect)(Data_Functor.map(Data_Functor.functorArray)(Test_Util.run)(Data_Array.concat(tests))));
  exports["tests"] = tests;
  exports["main"] = main;
  exports["pair"] = pair;
  exports["hole"] = hole;
  exports["test_scratchpad"] = test_scratchpad;
  exports["test_linking"] = test_linking;
  exports["test_slicing"] = test_slicing;
  exports["test_desugaring"] = test_desugaring;
  exports["test_misc"] = test_misc;
  exports["test_graphics"] = test_graphics;
})(PS);
PS["Test.Main"].main();