(() => {
  ...
  var closeDefs = (\u03B3) => (\u03C1) => _fmapObject(
    \u03C1,
    (\u03C3) => $Val("Closure", false, restrict(\u03B3)(unionWith2(ordString)($$const)(fv($$for(\u03C1)(\u03C3)))(fVElim.fv(\u03C3))), \u03C1, \u03C3)
  );
  ...
  var closeDefsFwd = (\u03B3) => (\u03C1) => (\u03B1) => _fmapObject(
    \u03C1,
    (\u03C3) => $Val("Closure", \u03B1, restrict(\u03B3)(unionWith2(ordString)($$const)(fv2($$for(\u03C1)(\u03C3)))(fVElim.fv(\u03C3))), \u03C1, \u03C3)
  );
