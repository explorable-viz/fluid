  ...
  var reflectArray = new $$Reflect(function (dictPartial) {
      return function (v) {
          if (v.value1 instanceof Val.Constr && (v.value1.value2 instanceof Data_List_Types.Nil && Data_Eq.eq(DataType.eqCtr)(v.value1.value1)(DataType.cNil))) {
              ...
              throw new Error("Failed pattern match at App.Util (line 44, column 7 - line 45, column 32): " + [ v1.constructor.name ]);
          };
          if (v.value1 instanceof Val.Constr && (v.value1.value2 instanceof Data_List_Types.Cons && (v.value1.value2.value1 instanceof Data_List_Types.Cons && (v.value1.value2.value1.value1 instanceof Data_List_Types.Nil && Data_Eq.eq(DataType.eqCtr)(v.value1.value1)(DataType.cCons))))) {
              ...
              throw new Error("Failed pattern match at App.Util (line 47, column 7 - line 48, column 70): " + [ v3.constructor.name ]);
          };
          throw new Error("Failed pattern match at App.Util (line 42, column 1 - line 48, column 70): " + [ v.constructor.name ]);
      };
  });
  exports["from"] = from;
...
(function($PS) {
  ...
  var valViews = function (v) {
      return function (v1) {
          return function (vars) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Traversable.sequence(Data_Traversable.traversableArray)(Data_Either.applicativeEither)(Data_Functor.map(Data_Functor.functorArray)(Data_Function.flip(varView$prime)(new Data_Tuple.Tuple(v1.value0, v1.value1)))(vars)))(function (views) {
                  return Control_Applicative.pure(Data_Either.applicativeEither)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(views)([ view("output")(new Data_Tuple.Tuple(v.value0, v.value1)) ]));
              });
          };
      };
  };
  ...
  var needs = function (v) {
      return function (o$prime) {
          ...
          return Control_Bind.bind(Data_Either.bindEither)(valViews(new Data_Tuple.Tuple(o$prime, v.ex_eval.o))(new Data_Tuple.Tuple(v1.value0.value0, Data_Semigroup.append(Util_SnocList.semigroupSnocList)(v.ex_eval.ex.ρ0)(v.ex_eval.ex.ρ)))(v.spec.vars))(function (views) {
              return Control_Applicative.pure(Data_Either.applicativeEither)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(views)([ view("output")(new Data_Tuple.Tuple(o$prime$prime, v.ex_eval.o)) ]));
          });
      };
  };
  ...
  var loadFig = function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Module.openDatasetAs("example/linking/renewables")("data"))(function (v1) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Data_Functor.map(Effect_Aff.functorAff)((function () {
              var $139 = splitDefs(Data_Semigroup.append(Util_SnocList.semigroupSnocList)(v1.value0)(v1.value1));
              return function ($140) {
                  return Util.successful($139($140));
              };
          })())(Module.open(v.file)))(function (v2) {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)({
                  spec: v,
                  ex_eval: Util.successful(evalExample({
                      ρ0: v1.value0,
      ...
      return function (redraw) {
          return function (n) {
              return function (v) {
                  ...
                  throw new Error("Failed pattern match at App.Renderer (line 44, column 1 - line 44, column 59): " + [ divId.constructor.name, redraw.constructor.name, n.constructor.name, v.constructor.name ]);
              };
          };
      };
  };
